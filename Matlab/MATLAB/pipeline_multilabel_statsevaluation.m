...
mask_dir = '/Volumes/Expansion Drive/User/Research/Brain_data/BRATS-2/Image_Data/';
%mask_dir = 'J:\User\Research\Results\BRATS-2_KNN_ENDAUGUST\';
brain_dir = '/Volumes/Expansion Drive/User/Research/Results/BRATS-2_KNN/'
...
%result_path = '/Volumes/Expansion Drive/User/Research/Results/BRATS-2_KNN_ENDAUGUST'
...
brain_type_list = brain_type_list(4:end);
     ...
     for brain_counter = 1:length(brain_list)
        ...
        for k = 1:length(file_list)
                    ...
                    if ~isempty(strfind(filename.name,'stat'))
                        ...
                        p(INDEX,:) = low_res.precision;
                        r(INDEX,:) = low_res.recall;
                        d (INDEX,:) = low_res.dice;
...
save([ 'all_stat_results_firstupload.mat'],'p','d','r' )
