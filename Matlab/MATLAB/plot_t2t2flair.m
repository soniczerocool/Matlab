...
for i=1:length(list)
    ...
    FLAIR = ((FLAIR - min(FLAIR)) / max(FLAIR)) * 2000; 
...
%     
 ...
 %% 
    ...
    h=figure(4);
    plot3(downsample(T1C(healthyidx),20),downsample(T2(healthyidx),20),downsample(FLAIR(healthyidx),20),'.b');
    hold on
    plot3(downsample(T1C(tumoridx),20),downsample(T2(tumoridx),20),downsample(FLAIR(tumoridx),20),'.b');
    plot3(downsample(T1C(edemaidx),20),downsample(T2(edemaidx),20),downsample(FLAIR(edemaidx),20),'.b');
    axis([-200 2000 -200 2000])
    xlabel('T1C')
    ylabel('T2')
    zlabel('FLAIR')
    saveas(h,[result_path_brain,'\','T1T2FLAIR.fig']);
    hold off;
