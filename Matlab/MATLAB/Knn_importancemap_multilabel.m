...
results_path_root = 'C:\Users\havm2701\Dropbox\PhD\BratsAnalysis\CHALLENGE2013_KNN\';
...
while decide == false
    ...
    if d==1
        ...
        MASK_sliceH = roipoly;
        MASK_sliceH = 0 * MASK_sliceH;
        imshow(MASK_sliceH);
        MASK(:,:, sliceH)= min((MASK(:,:, sliceH) +MASK_sliceH),2);
...
selected_points = find(mask_idx> -1); 
